...
public class UpdateDocumentTest {
    ...
    public void TestUpdate_WhenDocumentIsOnApprovedCantBeModified() {
        ...
        when(documentRepository.findById(documentDTO.getIcesiDocumentId())).thenReturn(Optional.of(document));
        when(userRepository.findById(any())).thenReturn(Optional.of(user));

        // Assert
        var exception = assertThrows(IcesiException.class, () -> documentService.updateDocument(documentDTO.getIcesiDocumentId().toString(),documentDTO), "No exception was thrown");
